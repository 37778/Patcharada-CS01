...
btnC=Button(fg="black",bg="lime",font=('arial',30,'bold'),text="C",command=clear,padx=30,pady=15).grid(row=1,column=3)
...
btnplus=Button(fg="black",bg="pink",font=('arial',30,'bold'),command=lambda:btn("+"),text="+",padx=32,pady=15).grid(row=2,column=3)
...
btnminus=Button(fg="black",bg="pink",font=('arial',30,'bold'),command=lambda:btn("-"),text="-",padx=37,pady=15).grid(row=3,column=3)

#row4
btndot=Button(fg="black",bg="yellow",font=('arial',30,'bold'),text=".",command=lambda:btn("."),padx=35,pady=15).grid(row=4,column=0)
btn0=Button(fg="black",font=('arial',30,'bold'),text="0",command=lambda:btn(0),padx=30,pady=15).grid(row=4,column=1)
btndivision=Button(fg="black",bg="pink",font=('arial',30,'bold'),text="/",command=lambda:btn("/"),padx=36,pady=15).grid(row=4,column=2)
btnmultiply=Button(fg="black",bg="pink",font=('arial',30,'bold'),text="x",command=lambda:btn("*"),padx=33,pady=15).grid(row=4,column=3)

#row5
btnequal=Button(fg="black",bg="orange",font=('arial',30,'bold'),text="=",command=equal,padx=93,pady=15).grid(row=5,column=0,columnspan=2)
btnopen=Button(fg="black",bg="cyan",font=('arial',30,'bold'),text="(",command=lambda:btn("("),padx=36,pady=15).grid(row=5,column=2)
btnclose=Button(fg="black",bg="cyan",font=('arial',30,'bold'),text=")",command=lambda:btn(")"),padx=36,pady=15).grid(row=5,column=3)
