...
btnplus=Button(fg="black",bg="orange",font=('arial',30,'bold'),command=lambda:btn("+"),text="+",padx=32,pady=15).grid(row=2,column=3)
...
btnminus=Button(fg="black",bg="orange",font=('arial',30,'bold'),command=lambda:btn("-"),text="-",padx=37,pady=15).grid(row=3,column=3)
